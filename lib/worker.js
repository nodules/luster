...
class Worker extends ClusterProcess {
    constructor() {
        ...
        this.on('foreign properties received', function() {
            this._foreignPropertiesReceived = true;
        }.bind(this));
     ...
     * @private
     */
    _broadcastEvent(event) { // eslint-disable-line no-unused-vars
        const args = [RPC.fns.master.broadcastWorkerEvent],
