...
class WorkerWrapper extends EventEmitterEx {
    constructor(master, options) {
         ...
         */
        let _state = WorkerWrapper.STATES.STOPPED;
     ...
     * @param {String} event
     */
    static broadcastWorkerEvent(worker, event) {
        const args = ['received worker ' + event, worker],
    ...
    send() {
        this._worker.send.apply(this._worker, arguments);
    }
